...
from miniformer import Transformer, TransformerConfig, setup_logging
from miniformer.config import BASE_CONFIG, SMALL_CONFIG, TINY_CONFIG
...
def main():
    ...
    parser.add_argument(
        "--log-level", choices=["DEBUG", "INFO", "WARNING"], default="INFO", help="Logging level"
    )
